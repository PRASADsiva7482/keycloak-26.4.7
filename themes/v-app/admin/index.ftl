...
<html lang="en">
  <head>
    ...
    <meta name="description" content="${properties.description!'The V-App Administration Console is a web-based interface for managing V-App.'}">
    <title>${properties.title!'V-App Administration Console'}</title>
    <style>
      body {
        margin: 0;
      }
  ...
  <body data-page-id="admin">
    <div id="app">
      <main class="container">
        <div class="keycloak__loading-container">
          ...
          <div>
            <p id="loading-text">Loading V-App Administration Console</p>
          </div>
        </div>
      </main>
    </div>
    <noscript>JavaScript is required to use the V-App Administration Console.</noscript>
    ...
    <script>
      // V-App Branding: Replace Keycloak references in the admin UI
      (function() {
        ...
        // Run repeatedly as React renders content
        var attempts = 0;
