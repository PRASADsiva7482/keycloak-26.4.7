          ...
          <main class="pf-v5-c-login__main">
            <header class="pf-v5-c-login__main-header">
              <#if localUser>
                ...
                <#if !successMessage?has_content>
                  <p class="pf-v5-c-login__main-header-desc">To get started with V-App, you first create an administrative user.</p>
                </#if>
              <#else>
            ...
            <div class="pf-v5-c-login__main-body">
              <#if successMessage?has_content>
                ...
                <a class="pf-v5-c-button pf-m-primary pf-m-block" href="${adminUrl}">Open V-App Administration Console</a>
              </#if>
              <#if bootstrap>
                <#if localUser>
                ...
                <#else>
                  <p>To create the administrative user, access the V-App Administration Console over localhost, or use a <code>bootstrap-admin</code> command.</p>
                </#if>
              </#if>
            </div>
          </main>
